    ...
    public static class Program
    {
        public static int Main(string[] args)
        {
            try
            {
                ...
                Rectangle range = new Rectangle(bmp.Width / 4, bmp.Height / 4, bmp.Width / 2, bmp.Height / 2);
                Type fx_inv_t = asm.GetType("SeeSharp.Effects.InvertBitmapEffect");
                object fx_inv = Activator.CreateInstance(fx_inv_t);

                fx_inv_t.GetProperty("Range").SetValue(fx_inv, range);
...
{string.Join("\n", from t in effects select $"    * [{t.Item2.Name}](#{t.Item2.Name})")}
...
<img src=""{save(fx_inv_t.GetMethod("Apply").Invoke(fx_inv, new object[] { bmp }) as Bitmap)}"" height=""200""/>
